...
export const signupTransactionscopy = async (symbolTargetPublicAccount:PublicAccount, password: string, secletLockTx?: SecretLockTransaction ): Promise<AggregateTransaction> => {
